...
impactContent = "Hello,<br><br>IGO processing is now complete. FASTQ files for your %s Project %s have been posted to the %s shared drive and transferred to the CMO Analysis Support (CAS) Team for pipeline analysis. You will be contacted when this project is delivered to cBioPortal."

wesWithCCSContent = "Hello,<br><br>IGO processing is now complete. FASTQ files for your %s Project %s have been posted to the %s shared drive and transferred to the CMO Computational Sciences (CCS) Team for pipeline analysis. Please contact your Project Manager for updates."

accessContent = "Hello,<br><br>IGO processing is now complete. FASTQ files for your %s Project %s have been posted to the %s shared drive and transferred to the ACCESS Analysis Team for data quality control and standard data processing. Please contact your Project Manager for further updates."

genericAnalysisContent = "Hello,<br><br>IGO processing is now complete. FASTQ files for your %s Project %s have been posted to the %s shared drive and are accessible to the Bioinformatics Core (BIC). Please go to <a href='https://bic.mskcc.org/bic/services/request/'>https://bic.mskcc.org/bic/services/request/</a> to initiate a request for analysis. For information about accessing your fastq files, please go to <a href='http://genomics.mskcc.org/accessing-your-data/'> genomics.mskcc.org/accessing-your-data </a>"
...
RNASeqAddon = "<br>In addition, IGO also deliver BAM files for your project. The detailed description of BAM generation command can be found <a href='https://genomics.mskcc.org/accessing-your-data#deliverables'> Data & Delivery </a>"
