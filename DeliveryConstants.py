...
DataStoragePolicyAddon = "<br><br><b>IGO's Data Storage Policy:</b><ul><li>FASTQ files will be linked to the project folder for 3 years</li><li>BAM files will be available for 3 months</li><li>Pipeline files (such as Cell Ranger) will be available for 3 months</li><li>POD5 files will be available for 7 days</li></ul>Deleted FASTQ, BAM, and pipeline files can be regenerated using an iLab request for a fee. <b>Deleted POD5 files cannot be recovered</b>."
