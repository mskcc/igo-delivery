...
accessContent = "Hello,<br><br>IGO processing is now complete. FASTQ files for your %s Project %s have been posted to the <b>%s</b> shared drive and transferred to the ACCESS Analysis Team for data quality control and standard data processing. Please contact your Project Manager for further updates. For information about accessing your fastq files, please go to <a href='http://genomics.mskcc.org/accessing-your-data/'> genomics.mskcc.org/accessing-your-data </a>"
...
DataStoragePolicyAddon = "<br><br><b>IGO's Data Storage Policy:</b><ul><li>FASTQ files will be linked to the project folder for 2 years</li><li>BAM files will be available for 3 months</li><li>Pipeline files (such as Cell Ranger) will be available for 3 months</li><li>POD5 files will be available for 7 days</li></ul>Deleted FASTQ, BAM, and pipeline files can be regenerated using an iLab request for a fee. <b>Deleted POD5 files cannot be recovered</b>."

FOOTER = "<br><br>Thank you, <br><a href='http://genomics.mskcc.org/'>Integrated Genomics Operation</a><br><a href='https://www.mskcc.org'>Memorial Sloan Kettering Cancer Center</a><br>Follow us on <a href='https://www.linkedin.com/company/igo-mskcc/posts/?feedView=all'>LinkedIn</a>!<br><br>Please rate your delivery experience <a href='https://genomics.mskcc.org/feedback/data-delivery'>here</a><br>"
